...
import v.shook.R;
import v.shook.player.PlayerMediaPlayer;
...
import static v.shook.library.LibraryService.CACHE_SEPARATOR;
...
public abstract class Source
{
    ...
    public static Source SOURCE_LOCAL_LIB = new Source(R.drawable.ic_local, 0, "Local")
    {
        ...
        public void registerSongs()
        {
            ...
            System.out.println("[Shook-LOCAL] Registering songs...");
            ...
            System.out.println("[Shook-LOCAL] Songs registered");
        }
    ...
    {
        public final String SPOTIFY_CLIENT_ID = "8830eb1043e343cc88ee680c4b487196";
        public final String SPOTIFY_REDIRECT_URI = "http://localhost:8888/callback";
                ...
                new Thread()
                {
                    public void run()
                    {
                        ...
                        catch(RetrofitError e)
                        {
                            ...
                            {
                                Log.println(Log.INFO, "[Shook-SPOTIFY]", "Actualizing token.");
                                refreshSpotifyToken();
                                mePrivate = spotifyApi.getService().getMe();
                            }
                        }
        ...
        public void registerCachedSongs()
        {
            ...
            System.out.println("[Shook-SPOTIFY] Registering cached songs...");
            try
            {
            ...
            {
                Log.println(Log.ERROR, "[Shook-SPOTIFY]", "Cache restore : IOException");
                e.printStackTrace();
            }
            System.out.println("[Shook-SPOTIFY] Cached songs registered.");
        }
        ...
        public void registerSongs()
        {
            ...
            try
            {
                ...
                {
                    Log.println(Log.ERROR, "[Shook-SPOTIFY]", "Error while writing cache !");
                }
            }
        ...
        private void refreshSpotifyToken()
        {
            try
            {
                ...
                writer.write("client_secret=" + "dbb33c38ee3442e1ac1e948998f89e2b");
                writer.flush();
                writer.close();
                out.close();
                ...
                System.out.println("[Shook] [AUTH-REFRESH] Result : " + urlConnection.getResponseCode() + " " + urlConnection.getResponseMessage());
    ...
    {
        public final String DEEZER_CLIENT_ID = "276402";
        ...
        public void registerCachedSongs()
        {
            ...
            System.out.println("[Shook-DEEZER] Registering cached songs...");
            ...
            {
                Log.println(Log.ERROR, "[Shook-DEEZER]", "Cache restore : IOException");
                e.printStackTrace();
            }
            System.out.println("[Shook-DEEZER] Cached songs registered.");
        }
        ...
        public void registerSongs()
        {
            ...
            try
            {
                ...
                {
                    Log.println(Log.ERROR, "[Shook-DEEZER]", "Error while writing cache !");
                }
            }
            catch(Exception e)
            {
